...
def main():
    ...
    collected_papers, total_raw_hits, bucket_paper_count = collect_papers(
    ...
    print(f"Raw API hits: {total_raw_hits}")
    print(f"Papers after grouping: {bucket_paper_count}")
    print(f"Papers after enrichment/filtering: {len(collected_papers)}")
